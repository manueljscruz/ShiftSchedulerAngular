...
export const DELETE_ENTITY_URL : string = BASE_API_URL + "Entity/delete-by-id";
...
export const DELETE_SHIFT_URL : string = BASE_API_URL + "Shift/delete-entity-shift";
export const DELETE_SHIFT_BREAK_URL : string = BASE_API_URL + "Shift/delete-entity-shift-break";
...
export const DELETE_RULE_URL : string = BASE_API_URL + "EntityRule/delete-entity-rule";
export const DELETE_RULE_SPEC_URL : string = BASE_API_URL + "EntityRule/delete-entity-rule-spec";
export const DELETE_RULE_SPECS_URL : string = BASE_API_URL + "EntityRule/delete-entity-rule-specs";
