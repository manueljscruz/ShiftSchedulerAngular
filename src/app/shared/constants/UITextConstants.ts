...
export const KICK_OUT_MEMBER_TITLE = 'Kick Out Member';
export const KICK_OUT_MEMBER_CONTENT = 'You are about to remove this member from the organisation. They will lose access immediately. This action cannot be undone. Are you sure you want to proceed?';
